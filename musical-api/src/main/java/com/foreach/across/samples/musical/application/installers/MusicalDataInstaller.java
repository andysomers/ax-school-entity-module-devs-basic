...
public class MusicalDataInstaller {
    ...
    public void install() {
        ...
        Musical peterPanMusical = Musical.builder()
                ...
                .description("In February 2019 Music Hall brings the timeless story of Peter Pan, 'the boy who did not want to grow up', to the halls again in a brand new, enchanting version. An international cast, countless surprises, magical images and amazing choreographies, provide an unforgettable theater experience.")
                .build();
        ...
        Musical smurfenDeMusical = Musical.builder()
                ...
                .description("Smurfs the Musical has received praise from all over the world, but the Smurfs have never been on stage in Belgium. In March 2019 this international production will finally comes to our country.")
                .build();
